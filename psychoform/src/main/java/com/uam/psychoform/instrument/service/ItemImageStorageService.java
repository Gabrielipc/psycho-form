...
public class ItemImageStorageService {
    ...
    private final SupabaseObjectStorageService storage;
    ...
    public ItemImageStorageService(ItemLookupRepository items, RecursoMultimediaRepository recursos,
            ...
            AuditLogService audit, Clock clock, SupabaseObjectStorageService storage) {
        this.items = items;
    ...
    public ImageView upload(long itemId, MultipartFile file, String role, Integer order, String altText) {
        ...
        try {
            ...
            storage.upload(objectPath, bytes, contentType);
            ...
            try {
                ...
                // Best-effort cleanup if database persistence fails after Supabase upload.
            }
    ...
    public StoredFile readResource(long resourceId) {
        ...
        var object = storage.download(resource.getRutaAlmacenamiento(), resource.getNombreArchivo(), resource.getTipoMime());
        return new StoredFile(object.fileName(), object.mimeType(), object.bytes());
    }
    ...
    public void deleteImage(long imageId) {
        ...
        storage.delete(resource.getRutaAlmacenamiento());
