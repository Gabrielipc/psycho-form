...
import com.uam.psychoform.scoring.model.*;
...
public class ManualReviewService {
    ...
    public List<PendingReviewView> pending() {
        return reviews.findByEstadoOrderByCreadoEnAsc(EstadoRevisionManual.PENDIENTE).stream().map(this::toView).toList();
    }
    ...
    public PendingReviewView createPendingForAnswer(Long answerId) {
        ...
        review.setReglaCalificacion(null);
